...
class PrimeFactorsSpec extends FlatSpec with Matchers {
  ...
  it should "give factors of 1980 as [2 2 3 3 5 11]" in {
    PrimeFactors.factors(1980) should equal (List(2,2,3,3,5,11))
  }

  it should "give factors of 1792560 as [2 2 2 2 3 5 7 11 97]" in {
    PrimeFactors.factors(1792560) should equal (List(2,2,2,2,3,5,7,11,97))
  }
